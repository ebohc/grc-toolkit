...
Template and full workbook: [github.com/ebohc/incident-response-grc](https://github.com/ebohc/incident-response-grc). More of my GRC work at [github.com/ebohc](https://github.com/ebohc). Feel free to connect on LinkedIn too.
