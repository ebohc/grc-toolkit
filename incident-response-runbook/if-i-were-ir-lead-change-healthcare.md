...
This one's a companion to my NIST 800-61 breakdown of the same incident, also in this repo: [github.com/ebohc/incident-response-grc](https://github.com/ebohc/incident-response-grc). Full template, RACI matrix, and control mapping are there too.
